---
name: ccgs-localize
description: "Use when the user wants the Claude Code Game Studios \"localize\" workflow in Codex. Run the localization workflow: extract strings, validate localization readiness, check for hardcoded text, and generate translation-ready string tables."
---

# CCGS Localize

Codex adaptation of the Claude Code Game Studios `localize` workflow.

## Codex Translation Layer

- Original slash command: `/localize`
- Codex skill name: `ccgs-localize`
