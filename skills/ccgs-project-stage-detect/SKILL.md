...
description: "Use when the user wants the Claude Code Game Studios \"project-stage-detect\" workflow in Codex. Automatically analyze project state, detect stage, identify gaps, and recommend next steps based on existing artifacts."
---

# CCGS Project Stage Detect

Codex adaptation of the Claude Code Game Studios `project-stage-detect` workflow.

## Codex Translation Layer

- Original slash command: `/project-stage-detect`
- Codex skill name: `ccgs-project-stage-detect`
