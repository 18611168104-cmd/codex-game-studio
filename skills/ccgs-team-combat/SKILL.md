...
description: "Use when the user wants the Claude Code Game Studios \"team-combat\" workflow in Codex. Orchestrate the combat team: coordinates game-designer, gameplay-programmer, ai-programmer, technical-artist, sound-designer, and qa-tester to design, implement, and validate a combat feature end-to-end."
---

# CCGS Team Combat

Codex adaptation of the Claude Code Game Studios `team-combat` workflow.

## Codex Translation Layer

- Original slash command: `/team-combat`
- Codex skill name: `ccgs-team-combat`
