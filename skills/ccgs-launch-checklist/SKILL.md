...
description: "Use when the user wants the Claude Code Game Studios \"launch-checklist\" workflow in Codex. Complete launch readiness validation covering every department: code, content, store, marketing, community, infrastructure, legal, and go/no-go sign-offs."
---

# CCGS Launch Checklist

Codex adaptation of the Claude Code Game Studios `launch-checklist` workflow.

## Codex Translation Layer

- Original slash command: `/launch-checklist`
- Codex skill name: `ccgs-launch-checklist`
