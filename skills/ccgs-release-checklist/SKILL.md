...
description: "Use when the user wants the Claude Code Game Studios \"release-checklist\" workflow in Codex. Generates a comprehensive pre-release validation checklist covering build verification, certification requirements, store metadata, and launch readiness."
---

# CCGS Release Checklist

Codex adaptation of the Claude Code Game Studios `release-checklist` workflow.

## Codex Translation Layer

- Original slash command: `/release-checklist`
- Codex skill name: `ccgs-release-checklist`
