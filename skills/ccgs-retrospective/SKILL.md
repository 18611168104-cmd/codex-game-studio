...
description: "Use when the user wants the Claude Code Game Studios \"retrospective\" workflow in Codex. Generates a sprint or milestone retrospective by analyzing completed work, velocity, blockers, and patterns. Produces actionable insights for the next iteration."
---

# CCGS Retrospective

Codex adaptation of the Claude Code Game Studios `retrospective` workflow.

## Codex Translation Layer

- Original slash command: `/retrospective`
- Codex skill name: `ccgs-retrospective`
