---
name: ccgs-team-ui
description: "Use when the user wants the Claude Code Game Studios \"team-ui\" workflow in Codex. Orchestrate the UI team: coordinates ux-designer, ui-programmer, and art-director to design, implement, and polish a user interface feature from wireframe to final."
---

# CCGS Team Ui

Codex adaptation of the Claude Code Game Studios `team-ui` workflow.

## Codex Translation Layer

- Original slash command: `/team-ui`
- Codex skill name: `ccgs-team-ui`
