...
description: "Use when the user wants the Claude Code Game Studios \"perf-profile\" workflow in Codex. Structured performance profiling workflow. Identifies bottlenecks, measures against budgets, and generates optimization recommendations with priority rankings."
---

# CCGS Perf Profile

Codex adaptation of the Claude Code Game Studios `perf-profile` workflow.

## Codex Translation Layer

- Original slash command: `/perf-profile`
- Codex skill name: `ccgs-perf-profile`
