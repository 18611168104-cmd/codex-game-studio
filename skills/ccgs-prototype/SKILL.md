---
name: ccgs-prototype
description: "Use when the user wants the Claude Code Game Studios \"prototype\" workflow in Codex. Rapid prototyping workflow. Skips normal standards to quickly validate a game concept or mechanic. Produces throwaway code and a structured prototype report."
---

# CCGS Prototype

Codex adaptation of the Claude Code Game Studios `prototype` workflow.

## Codex Translation Layer

- Original slash command: `/prototype`
- Codex skill name: `ccgs-prototype`
