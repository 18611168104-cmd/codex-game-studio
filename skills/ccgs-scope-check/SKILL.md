...
description: "Use when the user wants the Claude Code Game Studios \"scope-check\" workflow in Codex. Analyze a feature or sprint for scope creep by comparing current scope against the original plan. Flags additions, quantifies bloat, and recommends cuts."
---

# CCGS Scope Check

Codex adaptation of the Claude Code Game Studios `scope-check` workflow.

## Codex Translation Layer

- Original slash command: `/scope-check`
- Codex skill name: `ccgs-scope-check`
