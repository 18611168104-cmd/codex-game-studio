---
name: ccgs-estimate
description: "Use when the user wants the Claude Code Game Studios \"estimate\" workflow in Codex. Estimates task effort by analyzing complexity, dependencies, historical velocity, and risk factors. Produces a structured estimate with confidence levels."
---

# CCGS Estimate

Codex adaptation of the Claude Code Game Studios `estimate` workflow.

## Codex Translation Layer

- Original slash command: `/estimate`
- Codex skill name: `ccgs-estimate`
