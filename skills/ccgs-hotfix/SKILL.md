---
name: ccgs-hotfix
description: "Use when the user wants the Claude Code Game Studios \"hotfix\" workflow in Codex. Emergency fix workflow that bypasses normal sprint processes with a full audit trail. Creates hotfix branch, tracks approvals, and ensures the fix is backported correctly."
---

# CCGS Hotfix

Codex adaptation of the Claude Code Game Studios `hotfix` workflow.

## Codex Translation Layer

- Original slash command: `/hotfix`
- Codex skill name: `ccgs-hotfix`
