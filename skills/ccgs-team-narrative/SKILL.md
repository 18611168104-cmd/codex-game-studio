...
description: "Use when the user wants the Claude Code Game Studios \"team-narrative\" workflow in Codex. Orchestrate the narrative team: coordinates narrative-director, writer, world-builder, and level-designer to create cohesive story content, world lore, and narrative-driven level design."
---

# CCGS Team Narrative

Codex adaptation of the Claude Code Game Studios `team-narrative` workflow.

## Codex Translation Layer

- Original slash command: `/team-narrative`
- Codex skill name: `ccgs-team-narrative`
