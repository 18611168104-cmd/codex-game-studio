...
description: "Use when the user wants the Claude Code Game Studios \"team-level\" workflow in Codex. Orchestrate level design team: level-designer + narrative-director + world-builder + art-director + systems-designer + qa-tester for complete area/level creation."
---

# CCGS Team Level

Codex adaptation of the Claude Code Game Studios `team-level` workflow.

## Codex Translation Layer

- Original slash command: `/team-level`
- Codex skill name: `ccgs-team-level`
