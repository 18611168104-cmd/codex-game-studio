...
description: "Use when the user wants the Claude Code Game Studios \"design-review\" workflow in Codex. Reviews a game design document for completeness, internal consistency, implementability, and adherence to project design standards. Run this before handing a design document to programmers."
---

# CCGS Design Review

Codex adaptation of the Claude Code Game Studios `design-review` workflow.

## Codex Translation Layer

- Original slash command: `/design-review`
- Codex skill name: `ccgs-design-review`
...
9. **Contextual next step recommendations**:
   - If the document being reviewed is `game-concept.md` or `game-pillars.md`:
     ...
     - If it does NOT exist, add to Recommendations:
       > "This concept is ready for systems decomposition. Run `ccgs-map-systems`
   ...
   - If the document is an individual system GDD:
     ...
     - Note: This skill is read-only. The user (or `ccgs-design-system`) must
