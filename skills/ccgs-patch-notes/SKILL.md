...
description: "Use when the user wants the Claude Code Game Studios \"patch-notes\" workflow in Codex. Generate player-facing patch notes from git history, sprint data, and internal changelogs. Translates developer language into clear, engaging player communication."
---

# CCGS Patch Notes

Codex adaptation of the Claude Code Game Studios `patch-notes` workflow.

## Codex Translation Layer

- Original slash command: `/patch-notes`
- Codex skill name: `ccgs-patch-notes`
...
7. **Save the patch notes** to `production/releases/[version]ccgs-patch-notes.md`,
