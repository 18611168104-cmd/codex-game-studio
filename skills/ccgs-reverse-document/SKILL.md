...
description: "Use when the user wants the Claude Code Game Studios \"reverse-document\" workflow in Codex. Generate design or architecture documents from existing implementation. Works backwards from code/prototypes to create missing planning docs."
---

# CCGS Reverse Document

Codex adaptation of the Claude Code Game Studios `reverse-document` workflow.

## Codex Translation Layer

- Original slash command: `/reverse-document`
- Codex skill name: `ccgs-reverse-document`
...
```
User: ccgs-reverse-document design src/gameplay/combat
...
Agent:  Written to design/gdd/combat-system.md
       ...
       - Run ccgs-balance-check to validate progression curve
