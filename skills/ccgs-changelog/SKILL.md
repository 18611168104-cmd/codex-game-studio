---
name: ccgs-changelog
description: "Use when the user wants the Claude Code Game Studios \"changelog\" workflow in Codex. Auto-generates a changelog from git commits, sprint data, and design documents. Produces both internal and player-facing versions."
---

# CCGS Changelog

Codex adaptation of the Claude Code Game Studios `changelog` workflow.

## Codex Translation Layer

- Original slash command: `/changelog`
- Codex skill name: `ccgs-changelog`
